...
# simProbOfOutcomeBinary test data
# P_t1 <- rbeta(10, 10, 40)
...
# require oddsRatioCI from 
# EpiInputFunctions.R
# for odds ratio normal distribution
# input: OR_tn (range or single value), P_t1
# output: P_tn



# calculates P_tn for all binary models
# simProbOfOutcomeBinary <- function(
#   P_t1,
...
# ){
#   # for odds ratio
#   if(binaryRelativeScale_tn == "OR"){
#     
#     # for OR normal distribution
#     if(binaryDist_tn == "norm"){
#       output <- oddsRatioCI(OR_tn, P_t1)
#     }
#     
#     
#   }
...
# master function 
# requires: P_t1 vector

# simProbOfOutcomeMatrixBinary.v2 <- function(numberOfTreatments, P_t1,
